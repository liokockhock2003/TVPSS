		...
		<div class="main-content">
			...
			<div class="card">
				<div class="form-container">
					<form
						action="${pageContext.request.contextPath}/manage-school/edit-resource/${resource.id}/${schoolId}"
						method="POST">
						<div class="form-group">
							<label class="form-label">Resource Type*</label> <input
								type="text" name="type" class="form-control" value="${resource.type}" required>
							<div class="info-text">E.g., Camera, Microphone, Tripod</div>
						</div>

						<div class="form-group">
							<label class="form-label">Brand</label> <input type="text"
								name="brand" class="form-control" value="${resource.brand}">
						</div>

						<div class="form-group">
							<label class="form-label">Model</label> <input type="text"
								name="model" class="form-control" value="${resource.model}">
						</div>
						...
						<div class="d-flex justify-content-end mt-4">
							...
							<button type="submit" class="submit-btn">Edit Resource</button>
						</div>
					</form>
				</div>
			</div>
