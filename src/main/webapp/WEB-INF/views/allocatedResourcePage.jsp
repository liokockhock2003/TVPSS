...
<body>
    <div class="main-container">
        ...
        <div class="main-content">
            ...
            <h3 class="mb-4">Allocated Resources</h3>
                            ...
                            <c:forEach items="${resources}" var="resource" varStatus="status">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/manage-school/remove-resource/${crew.id}/${resource.id}/${schoolId}" 
                                           class="manage-btn" 
    ...
    <script>
        function confirmRemove() {
            return confirm("Are you sure you want to remove this resource from the crew member?");
        }
    </script>
</body>
</html>